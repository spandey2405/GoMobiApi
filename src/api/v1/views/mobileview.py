...
class MobilesView( LoggingMixin, generics.GenericAPIView, mixins.UpdateModelMixin, mixins.DestroyModelMixin, mixins.ListModelMixin):
    ...
    def get(self,request):
        ...
        return CustomResponse(message='User added', payload="GET BRAND LIST HERE", code=HTTP_200_OK)

    @auto_close_db
    def post(self, request):
        mobile_list = request.data.copy()
        payload = api_lib.add_mobiles(mobilelist=mobile_list)
